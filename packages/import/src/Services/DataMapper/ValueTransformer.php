...
namespace Elaitech\Import\Services\DataMapper;
...
final class ValueTransformer
{
    ...
    {
        $this->registerTransformer(new \Elaitech\Import\Services\DataMapper\Transformers\NoneTransformer);
        $this->registerTransformer(new \Elaitech\Import\Services\DataMapper\Transformers\TrimTransformer);
        $this->registerTransformer(new \Elaitech\Import\Services\DataMapper\Transformers\UpperTransformer);
        $this->registerTransformer(new \Elaitech\Import\Services\DataMapper\Transformers\LowerTransformer);
        $this->registerTransformer(new \Elaitech\Import\Services\DataMapper\Transformers\IntegerTransformer);
        $this->registerTransformer(new Transformers\FloatTransformer);
        $this->registerTransformer(new \Elaitech\Import\Services\DataMapper\Transformers\BooleanTransformer);
        $this->registerTransformer(new \Elaitech\Import\Services\DataMapper\Transformers\DateTransformer);
        $this->registerTransformer(new \Elaitech\Import\Services\DataMapper\Transformers\ArrayFirstTransformer);
        $this->registerTransformer(new \Elaitech\Import\Services\DataMapper\Transformers\ArrayJoinTransformer);
    }
}
