...
const submit = () => {
  form.post(route('dashboard.organization.target-fields.store'))
}
</script>

<template>
  <Head title="Create Target Field" />

  <Default>
    <PageHeader
      title="Create Target Field"
      description="Define a new field for your data import mapping."
    >
      <template #actions>
        ...
        <form @submit.prevent="submit">
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>
                        Configuration for the target field.
                    </CardDescription>
                </CardHeader>
                ...
                <CardFooter class="flex justify-end gap-2 border-t pt-4">
                    ...
                    <Button type="submit" :disabled="form.processing">
                        {{ form.processing ? 'Saving...' : 'Create Field' }}
                    </Button>
                </CardFooter>
            </Card>
        </form>
