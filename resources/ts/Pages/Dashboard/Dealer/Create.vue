...
const submit = () => {
  form.post(route('dashboard.dealers.store'))
}
</script>
...
<template>
  ...
  <Default>
    <PageHeader
      title="Create Dealer"
      description="Add a new dealer to your organization."
    >
      <template #actions>
      ...
      <form @submit.prevent="submit">
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Enter the dealer information below.
            </CardDescription>
          </CardHeader>
          ...
          <CardFooter class="flex justify-end gap-2 border-t pt-4">
            ...
            <Button type="submit" :disabled="form.processing">
              {{ form.processing ? 'Saving...' : 'Create Dealer' }}
            </Button>
          </CardFooter>
        </Card>
      </form>
