...
<template>
  <div class="mb-6 space-y-3">
    <div>
      <FormLabel class="text-base font-semibold">Reader Type <span class="text-destructive ml-1">*</span></FormLabel>
      <p class="text-sm text-muted-foreground mt-1">
        Choose the type of reader for your data format
      </p>
    </div>
    
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-3">
      <div
        v-for="(type, key) in READER_TYPES"
        :key="key"
